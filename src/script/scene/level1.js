...
class level1 extends Phaser.Scene{
    ...
    preload () {
        ...
        this.load.tilemapTiledJSON('map2', 'src/maps/laMap2.JSON');
    ...
    create () {
        ...
        var tileset = map2.addTilesetImage('pirate', 'pirates');
        var groundLayer = map2.createLayer('Calque de Tuiles 1', tileset, 0, 0);
        var secondLayer = map2.createLayer('Calque de Tuiles 2', tileset, 0, 0);
        var thirdLayer = map2.createLayer('dead', tileset, 0, 0);
        ...
        doorEnd = this.add.sprite(4816, 508,'door');
        ...
        meat1 = this.physics.add.image(650,510,'meat');
        meat2 = this.physics.add.image(2170,25,'meat');
        meat3 = this.physics.add.image(3578,450,'meat');
