...
function preload ()
{
    ...
    this.load.spritesheet('player', 'image/luffy.png', { frameWidth: 32, frameHeight: 48 });
...
function create ()
{
    ...
    //var platformLayer = map.createLayer('Calque de Tuiles 2', tileset, 0, 0);
    //var backgroundLayer = map.createLayer('Calque de Tuiles 3', tileset, 0, 0);
   
    // Set collision with player (can also be a group)
    //groundLayer.setCollisionByExclusion([-1]);
    //this.physics.add.collider(playerController, groundLayer);
    ...
    //map.setCollisionBetween(1, 999, true, 'Calque de Tuiles 1');
    ...
    player = this.physics.add.sprite(100, 511, 'luffy');
...
{
     //this.game.physics.arcade.collide(luffy, groundLayer);
